...
const Renderer = ({ title, component, toc, sidebar, fallback }) => (
	<MuiThemeProvider muiTheme={getMuiTheme({ palette: { primary1Color: '#6363AD' } })}>
		<div className={classnames(s.root, { [s.withoutSidebar]: !sidebar })}>
			<AppBar className={cs.appBar} title={title}
					iconElementLeft={<SvgIcon viewBox="0 0 78 72" style={{margin: 10}}><path fill="#FFFFFF" d="M77.556,10.608c-0.229-0.491-0.708-0.816-1.249-0.849L53.565,8.432c-0.554-0.031-1.081,0.25-1.361,0.73
				...
				<path id="A_1_" fill="#FFFFFF" d="M38.894,0.001c-0.015,0-0.03,0.003-0.045,0.005C38.83,0.004,38.815,0.001,38.8,0.001
                        ...
                        c9.818,0.338,15.175,17.001,23.296,13.136C70.45,67.444,51.16-0.323,38.894,0.001z"></path></SvgIcon>}
					iconElementRight={<IconButton href="https://github.com/Whataboon/ComponentsLibrary"><img src={GithubLogo} /></IconButton>} />

			<main className={classnames(s.wrapper, cs.wrapper)}>
